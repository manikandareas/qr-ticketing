...
export async function getCurrentSession(args: any) {
...
export default function App({ loaderData }: Route.ComponentProps) {
	return (
		<ClerkProvider
			...
			afterSignOutUrl="/"
			signInFallbackRedirectUrl={"/auth/redirect?next=/dashboard"}
			signUpFallbackRedirectUrl={"/auth/redirect?next=/dashboard"}
		>
